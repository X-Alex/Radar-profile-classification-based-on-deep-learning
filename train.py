# -*- coding: utf-8 -*-
"""
Created on Wed Oct 25 12:46:31 2017
...
#数据集地址
path='C:/Users/zfh/Desktop/traindataset/'
#模型保存地址
...
def inference(input_tensor, train, regularizer):
    ...
    with tf.variable_scope("layer9-conv5"):
        conv5_weights = tf.get_variable("weight",[3,3,128,128],initializer=tf.truncated_normal_initializer(stddev=0.1))
